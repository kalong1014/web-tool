...
INSERT INTO `shua_config` VALUES ('admin_user', '亮哥牛逼');
INSERT INTO `shua_config` VALUES ('admin_pwd', 'liangge');
...
INSERT INTO `shua_config` VALUES ('sitename', '亮哥代刷下单平台');
INSERT INTO `shua_config` VALUES ('keywords', '亮哥代刷下单平台');
INSERT INTO `shua_config` VALUES ('description', '亮哥代刷下单平台');
INSERT INTO `shua_config` VALUES ('kfqq', '37499818');
...
<a target="_blank" class="btn btn-info" href="http://wpa.qq.com/msgrd?v=3&uin=在这里输入您的QQ&site=qq&menu=yes"><i class="fa fa-qq"></i> 联系客服</a>
<a target="_blank" class="btn btn-warning" href="在这里输入你的QQ群链接"><i class="fa fa-users"></i> 官方Q群</a>
...
<tbody>
<tr height="50">
<td><button type="button" class="btn btn-block btn-warning"><a href="http://lgsq.aoiuy.pw" target="_blank"><span style="color:#ffffff">♚亮哥社区♚</span></a></button></td>
<td><button type="button" class="btn btn-block btn-warning"><a href="http://lgsq.aoiuy.pw/" target="_blank"><span style="color:#ffffff">♚亮哥社区♚</span></a></button></td>
</tr>
<tr height="50">
...
INSERT INTO `shua_config` VALUES ('faka_mail', '<b>商品名称：</b> [name]<br/><b>购买时间：</b>[date]<br/><b>以下是你的卡密信息：</b><br/>[kmdata]<br/>----------<br/><b>使用说明：</b><br/>[alert]<br/>----------<br/>亮哥代刷下单平台<br/>[domain]');
