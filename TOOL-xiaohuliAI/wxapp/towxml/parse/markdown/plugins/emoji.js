...
!function(e) {
    if ("object" == ("undefined" == typeof exports ? "undefined" : a(exports)) && "undefined" != typeof module) module.exports = e(); else if ("function" == typeof define && define.amd) define([], e); else {
        ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).markdownitEmoji = e();
    }
}(function() {
            ...
            e.exports = function(a, e, n, o, i) {
                function r(a, o, r) {
                    ...
                    return a.replace(i, function(o, i, c) {
                        ...
                        i > t && ((_ = new r("text", "", 0)).content = a.slice(t, i), l.push(_)), (_ = new r("emoji", "", 0)).markup = m, 
                        _.content = e[m], l.push(_), t = i + o.length;
                    }), t < a.length && ((_ = new r("text", "", 0)).content = a.slice(t), l.push(_)), 
                    l;
                }
                ...
                return function(a) {
                    ...
                    for (n = 0, i = l.length; n < i; n++) if ("inline" === l[n].type) for (e = (t = l[n].children).length - 1; e >= 0; e--) "link_open" !== (s = t[e]).type && "link_close" !== s.type || "auto" === s.info && (c -= s.nesting), 
                    "text" === s.type && 0 === c && o.test(s.content) && (l[n].children = t = _(t, e, r(s.content, s.level, a.Token)));
                };
            };
        }, {} ],
        6: [ function(a, e, n) {
