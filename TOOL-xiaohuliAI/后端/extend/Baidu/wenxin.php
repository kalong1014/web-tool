...
class wenxin
{
    protected static $model = 'ERNIE-Bot';
    ...
    public function sendText($message = '', $system = '', $callback = null)
    {
        ...
        // system参数目前仅支持ERNIE-Bot模型
        if (self::$model == 'ERNIE-Bot' && $system) {
            $post['system'] = $system;
        }
        if (in_array(self::$model, ['ERNIE-Bot', 'ERNIE-Bot-turbo'])) {
            $post['temperature'] = self::$temperature;
        }
