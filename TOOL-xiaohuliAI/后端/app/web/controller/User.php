...
class User extends Base
{
    ...
    public function info()
    {
        ...
        return successJson([
            ...
            'balance_point' => $user['balance_point'] ?? 0
        ]);
    }
    ...
    public function getBalance()
    {
        ...
        return successJson([
            ...
            'balance_video' => $user['balance_video'] ?? 0,
            'balance_music' => $user['balance_music'] ?? 0,
    ...
    public function bindCard()
    {
        ...
        if (!in_array($card['type'], ['point', 'vip']) || intval($card['val']) <= 0) {
        ...
        try {
            if ($card['type'] == 'point') {
                changeUserBalance(self::$user['id'], $card['val'], '卡密兑换');
            }
